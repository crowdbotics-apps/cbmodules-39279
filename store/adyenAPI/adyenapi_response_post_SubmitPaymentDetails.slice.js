...
export const adyenapi_post_payments_details_create = createAsyncThunk("adyenapi_response_post_SubmitPaymentDetails/adyenapi_post_payments_details_create", async payload => {
  const response = await apiService.adyenapi_post_payments_details_create(payload);
