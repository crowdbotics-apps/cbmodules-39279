...
export const adyenapi_post_paymentMethods_create = createAsyncThunk(
  "adyenapi_response_post_GetListPaymentMethods/adyenapi_post_paymentMethods_create",
  async payload => {
    const response = await apiService.adyenapi_post_paymentMethods_create(
      payload
    )
