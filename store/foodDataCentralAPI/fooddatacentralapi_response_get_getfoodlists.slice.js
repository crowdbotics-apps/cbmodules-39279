...
export const fooddatacentralapi_get_v1_foods_list_list = createAsyncThunk(
  "fooddatacentralapi_response_get_getfoodlists/fooddatacentralapi_get_v1_foods_list_list",
  async payload => {
    const response = await apiService.fooddatacentralapi_get_v1_foods_list_list(
      payload
    )
