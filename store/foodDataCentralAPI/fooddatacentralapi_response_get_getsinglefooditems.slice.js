...
export const fooddatacentralapi_get_v1_foods_list = createAsyncThunk(
  "fooddatacentralapi_response_get_getsinglefooditems/fooddatacentralapi_get_v1_foods_list",
  async payload => {
    const response = await apiService.fooddatacentralapi_get_v1_foods_list(
      payload
    )
