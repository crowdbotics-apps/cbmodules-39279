...
export const stripepaymentapi_get_v1_balance_list = createAsyncThunk("stripepaymentapi_response_get_GetStripeBalances/stripepaymentapi_get_v1_balance_list", async payload => {
  const response = await apiService.stripepaymentapi_get_v1_balance_list(payload);
