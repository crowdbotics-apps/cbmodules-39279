...
export const retslybridgeapi_get_api_v2_test_agents_list = createAsyncThunk(
  "retslybridgeapi_response_get_GetAgentsLists/retslybridgeapi_get_api_v2_test_agents_list",
  async payload => {
    const response = await apiService.retslybridgeapi_get_api_v2_test_agents_list(
      payload
    )
...
const retslybridgeapi_response_get_GetAgentsListsSlice = createSlice({
  ...
  extraReducers: {
    ...
    [retslybridgeapi_get_api_v2_test_agents_list.fulfilled]: (
      state,
      action
    ) => {
