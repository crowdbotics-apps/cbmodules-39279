...
export const spotifyintegrations_get_artists_read = createAsyncThunk("spotifyintegrations_response_get_GetArtists/spotifyintegrations_get_artists_read", async payload => {
  const response = await apiService.spotifyintegrations_get_artists_read(payload);
