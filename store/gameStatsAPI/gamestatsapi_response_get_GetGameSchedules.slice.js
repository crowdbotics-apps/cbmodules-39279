...
export const gamestatsapi_get_scores_json_Games_list = createAsyncThunk(
  "gamestatsapi_response_get_GetGameSchedules/gamestatsapi_get_scores_json_Games_list",
  async payload => {
    const response = await apiService.gamestatsapi_get_scores_json_Games_list(
      payload
    )
