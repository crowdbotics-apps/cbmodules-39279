...
export const gamestatsapi_get_scores_json_News_list = createAsyncThunk("gamestatsapi_response_get_GetNews/gamestatsapi_get_scores_json_News_list", async payload => {
  const response = await apiService.gamestatsapi_get_scores_json_News_list(payload);
