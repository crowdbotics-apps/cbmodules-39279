...
export const hubspotapi_get_crm_v3_objects_contacts_list = createAsyncThunk("hubspotapi_response_get_GetCRMContactLists/hubspotapi_get_crm_v3_objects_contacts_list", async payload => {
  const response = await apiService.hubspotapi_get_crm_v3_objects_contacts_list(payload);
...
const hubspotapi_response_get_GetCRMContactListsSlice = createSlice({
  ...
  extraReducers: {
    ...
    [hubspotapi_get_crm_v3_objects_contacts_list.fulfilled]: (state, action) => {
