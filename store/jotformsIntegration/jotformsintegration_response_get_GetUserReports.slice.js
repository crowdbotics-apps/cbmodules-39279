...
export const jotformsintegration_get_reports_read = createAsyncThunk("jotformsintegration_response_get_GetUserReports/jotformsintegration_get_reports_read", async payload => {
  const response = await apiService.jotformsintegration_get_reports_read(payload);
