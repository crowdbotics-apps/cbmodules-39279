...
export const ubereatintegration_get_eats_stores_read = createAsyncThunk(
  "ubereatintegration_response_get_GetStoreDetails/ubereatintegration_get_eats_stores_read",
  async payload => {
    const response = await apiService.ubereatintegration_get_eats_stores_read(
      payload
    )
