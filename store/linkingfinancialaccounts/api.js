...
function linkingfinancialaccounts_get_v3_company_company_id_companyinfo_minor_version_read(
  payload
) {
  return linkingfinancialaccounts.get(
    `/v3/company/${payload.company_id}/companyinfo/${payload.minor_version}`
  )
}
