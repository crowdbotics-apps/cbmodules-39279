...
export const simplex_get_supported_countries_list = createAsyncThunk("simplex_response_get_SupportedCountries/simplex_get_supported_countries_list", async payload => {
  const response = await apiService.simplex_get_supported_countries_list(payload);
