...
export const emojiintegration_get_emojis_emojislug_list = createAsyncThunk("emojiintegration_response_get_Getsingleemojis/emojiintegration_get_emojis_emojislug_list", async payload => {
  const response = await apiService.emojiintegration_get_emojis_emojislug_list(payload);
