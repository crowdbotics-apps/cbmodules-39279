...
export const digitalwallet_post_register_wallet_create = createAsyncThunk("digitalwallet_response_post_RegisterWallets/digitalwallet_post_register_wallet_create", async payload => {
  const response = await apiService.digitalwallet_post_register_wallet_create(payload);
