...
function circleapi_get_v1_businessAccount_wallets_addresses_deposit_read(payload) {
  return circleAPI.get(`/v1/businessAccount/wallets/addresses/deposit`);
}

function circleapi_post_v1_businessAccount_wallets_addresses_deposit_create(payload) {
  return circleAPI.post(`/v1/businessAccount/wallets/addresses/deposit`, payload.data);
}
