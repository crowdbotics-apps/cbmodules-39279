...
export const couponapi_get_getIncrementalFeed_read = createAsyncThunk(
  "couponapi_response_get_GetIncrementalFeeds/couponapi_get_getIncrementalFeed_read",
  async payload => {
    const response = await apiService.couponapi_get_getIncrementalFeed_read(
      payload
    )
