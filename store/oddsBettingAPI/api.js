...
function oddsbettingapi_get_scores_list(payload) {
  return oddsBettingAPI.get(`/scores/`, {
    params: { daysFrom: payload.daysFrom, apiKey: payload.apiKey }
  })
}
function oddsbettingapi_get_sports_read(payload) {
  return oddsBettingAPI.get(`/sports/`, { params: { apiKey: payload.apiKey } })
}
function oddsbettingapi_get_sports_americanfootball_nfl_oddshistory_read(
  payload
) {
